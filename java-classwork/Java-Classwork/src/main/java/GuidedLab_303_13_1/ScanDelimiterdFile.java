...
public class ScanDelimiterdFile {
    public static void main(String args[]) throws FileNotFoundException {
        ...
        try {
            String location = "C:\\Users\\Alberto\\development\\2024-RTT-62\\cars.csv";
            ...
            for (String[] line : data){
               //19.	             //System.out.println(line[0] + "|" + line[1] + "|" + line[2] + "|" + line[3]  + line[4] + "|" + line[5] + "|" + line[6] + "|" + line[7] + "|" + line[8]);
               System.out.println("Car Name:" + line[0]);
               System.out.println("MPG:   " + line[1]);
                System.out.println("Cylinders:   " + line[2]);
